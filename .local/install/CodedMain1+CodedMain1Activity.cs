...
{
    public class CodedMain1Activity : System.Activities.Activity
    {
        public CodedMain1Activity()
        {
            this.Implementation = () =>
            {
                return new CodedMain1ActivityChild()
                {};
            };
        }
    }

    internal class CodedMain1ActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public CodedMain1ActivityChild()
        {
            DisplayName = "CodedMain1";
        }
        ...
        {
            var codedWorkflow = new global::CodedOStst1.CodedMain1();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CodedMain1.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "CodedMain1.cs", Exception = exception});
                }
